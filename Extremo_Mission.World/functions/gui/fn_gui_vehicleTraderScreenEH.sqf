/*
	...
	## Nikko Renolds
*/
player setVariable ["ExtremoWallet", 15000,true];
player setVariable ["ExtremoScore", 57433,true];

Extremo_fnc_gui_modelBox_update = {

};

Extremo_fnc_gui_vehicleTraderScreenEH = {
	...
	_controlsParams = _controls apply {[format["_control%1",_x#1],controlNull,[controlNull]]};
