...
Extremo_fnc_system_log = compileFinal ("diag_log format['Extremo "+(call Extremo_var_system_version)+": %1',_this]");
Extremo_fnc_system_kick = compileFinal ('
	...
	format [["Kicking Survivor (%1)","Kicking Survivor (%1) | Reason (%2)"] select (_message isNotEqualTo ""),getPlayerUID _player,_message] call Extremo_fnc_system_log;
